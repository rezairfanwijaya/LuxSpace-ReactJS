        ...
        <div className="flex -mx-4 flex-row relative">
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./img/content/image-arrived-1.png"
                alt=""
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./img/content/image-arrived-2.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./img/content/image-arrived-3.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./img/content/image-arrived-4.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="./img/content/image-arrived-5.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
